...
pushd "$OUT"
  unzip -o -j ~/.m2/repository/io/netty/netty-transport-native-epoll/$OSSFUZZ_NETTY_VERSION/netty-transport-native-epoll-$OSSFUZZ_NETTY_VERSION-linux-x86_64.jar META-INF/native/libnetty_transport_native_epoll_x86_64.so
  unzip -o -j ~/.m2/repository/io/netty/netty-tcnative/$OSSFUZZ_NETTY_TCNATIVE_VERSION/netty-tcnative-$OSSFUZZ_NETTY_TCNATIVE_VERSION-linux-x86_64.jar META-INF/native/libnetty_tcnative_linux_x86_64.so
  unzip -o -j ~/.m2/repository/io/netty/incubator/netty-incubator-transport-native-io_uring/$OSSFUZZ_NETTY_IOURING_VERSION/netty-incubator-transport-native-io_uring-$OSSFUZZ_NETTY_IOURING_VERSION-linux-x86_64.jar META-INF/native/libnetty_transport_native_io_uring_x86_64.so
popd
